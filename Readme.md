# AI Engineer Wiki — README

This wiki is a practical, project-focused guide for becoming an **AI engineer**.

It explains:

- what an AI engineer actually does
- the skill stack you need
- the fundamentals you should not skip
- how RAG, embeddings, and agents work
- how to deploy and operate AI systems
- three strong projects you can build to prove your skills
...
All links in this wiki are **relative links**.

That means they work best when all markdown pages are placed in the **wiki root**.

If you later create folders, you will need to update the links to include the folder path.
